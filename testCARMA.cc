...
int main(int argc, char *argv[])
{
	...
	asHelper.SetRouting("ns3::AquaSimCARMA", "Width", DoubleValue(100), "TargetPos", Vector3DValue(Vector(1000,1000,10)));
  ...
  //comman nodes
  //comman nodes
	Vector boundry = Vector((0), (0), 240);
    int pos[8][2]={{0,1000},{0,2000},{1000,0},{1000,1000},{1000,2000},{2000,0},{2000,1000},{2000,2000}};
	int pos1[24][2]={{0,500},{0,1000},{0,1500},{0,2000},
	                                  {500,0},{500,500},{500,1000},{500,1500},{500,2000},
									  {1000,0},{1000,500},{1000,1000},{1000,1500},{1000,2000},
									  {1500,0},{1500,500},{1500,1000},{1500,1500},{1500,2000},
									  {2000,0},{2000,500},{2000,1000},{2000,1500},{2000,2000}};
    int pos2[44][2]={{0,250},{0,500},{0,750},{0,1000},{0,1250},{0,1500},{0,1750},{0,2000},
	                                   {500,0},{500,250},{500,500},{500,750},{500,1000},{500,1250},{500,1500},{500,1750},{500,2000},
									   {1000,0},{1000,250},{1000,500},{1000,750},{1000,1000},{1000,1250},{1000,1500},{1000,1750},{1000,2000},
									   {1500,0},{1500,250},{1500,500},{1500,750},{1500,1000},{1500,1250},{1500,1500},{1500,1750},{1500,2000},
									    {2000,0},{2000,250},{2000,500},{2000,750},{2000,1000},{2000,1250},{2000,1500},{2000,1750},{2000,2000}};
	int pos3[62][2]={{0,250},{0,500},{0,750},{0,1000},{0,1250},{0,1500},{0,1750},{0,2000},
	                                  {500,0},{500,250},{500,500},{500,750},{500,1000},{500,1250},{500,1500},{500,1750},{500,2000},
									  {750,0},{750,250},{750,500},{750,750},{750,1000},{750,1250},{750,1500},{750,1750},{750,2000},
									  {1000,0},{1000,250},{1000,500},{1000,750},{1000,1000},{1000,1250},{1000,1500},{1000,1750},{1000,2000},
									  {1250,0},{1250,250},{1250,500},{1250,750},{1250,1000},{1250,1250},{1250,1500},{1250,1750},{1250,2000},
									  {1500,0},{1500,250},{1500,500},{1500,750},{1500,1000},{1500,1250},{1500,1500},{1500,1750},{1500,2000},
									  {2000,0},{2000,250},{2000,500},{2000,750},{2000,1000},{2000,1250},{2000,1500},{2000,1750},{2000,2000}};
	int pos4[80][2]={{0,250},{0,500},{0,750},{0,1000},{0,1250},{0,1500},{0,1750},{0,2000},
		                              {250,0},{250,250},{250,500},{250,750},{250,1000},{250,1250},{250,1500},{250,1750},{250,2000},
	                                  {500,0},{500,250},{500,500},{500,750},{500,1000},{500,1250},{500,1500},{500,1750},{500,2000},
									  {750,0},{750,250},{750,500},{750,750},{750,1000},{750,1250},{750,1500},{750,1750},{750,2000},
									  {1000,0},{1000,250},{1000,500},{1000,750},{1000,1000},{1000,1250},{1000,1500},{1000,1750},{1000,2000},
									  {1250,0},{1250,250},{1250,500},{1250,750},{1250,1000},{1250,1250},{1250,1500},{1250,1750},{1250,2000},
									  {1500,0},{1500,250},{1500,500},{1500,750},{1500,1000},{1500,1250},{1500,1500},{1500,1750},{1500,2000},
									  {1750,0},{1750,250},{1750,500},{1750,750},{1750,1000},{1750,1250},{1750,1500},{1750,1750},{1750,2000},
									  {2000,0},{2000,250},{2000,500},{2000,750},{2000,1000},{2000,1250},{2000,1500},{2000,1750},{2000,2000}};
    int index=0;
	int k = 1;
    int level=1;
...
//sink node create
  for (NodeContainer::Iterator i = sinksCon.Begin(); i != sinksCon.End(); i++)
	...
	if(nodes==6){
		socket.SetDestinationAddress(devices.Get(7)->GetAddress()); //Set dest to first sink (nodes+1 device)
	}else if(nodes==20){
		socket.SetDestinationAddress(devices.Get(21)->GetAddress()); //Set dest to first sink (nodes+1 device)
	}else if(nodes==40){
		socket.SetDestinationAddress(devices.Get(41)->GetAddress()); //Set dest to first sink (nodes+1 device)
	}
