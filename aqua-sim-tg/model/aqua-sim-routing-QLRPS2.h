...
#ifndef AQUA_SIM_ROUTING_QLRPS2_H
#define AQUA_SIM_ROUTING_QLRPS2_H
...
#include <map>
extern ns3::Vector allNodePosition2[18000][48];
namespace ns3
{
    ...
    class AquaSimPktlocalTableQLRPS2
    {
    public:
        std::map<local_entry, qlrp2_neighbor *> m_htable;
        AquaSimPktlocalTableQLRPS2();
        ~AquaSimPktlocalTableQLRPS2();
        ...
        qlrp2_neighbor *GetHash(AquaSimAddress forwarderAddr, Vector p);
    };
    /**
     * \ingroup aqua-sim-ng
     *
     * \brief Packet Hash table for QLRP to assist in specialized tables.
     */
    class AquaSimDataHashTableSQLRPS2
    {
    public:
        std::map<int *, int *> m_htable;
        // Tcl_HashTable htable;
        AquaSimDataHashTableSQLRPS2();
        ~AquaSimDataHashTableSQLRPS2();
     ...
     */
    class AquaSimQLRPS2 : public AquaSimRouting
    {
    public:
        AquaSimQLRPS2(); // 初始化本地表//定期调用 创建包发包
    ...
    protected:
        ...
        double theta;
        // int m_portNumber;
        AquaSimPktlocalTableQLRPS2 PktlocalTable;
...
#endif /* AQUA_SIM_ROUTING_QLRPS_H */
