...
#ifndef AQUA_SIM_ROUTING_QLRPS_H
#define AQUA_SIM_ROUTING_QLRPS_H
...
namespace ns3
{
  ...
  {
  public:
    std::map<local_entry, qlrp_neighbor *> m_htable;
    ...
    qlrp_neighbor *GetHash(AquaSimAddress forwarderAddr, Vector p);
  };
  /**
   * \ingroup aqua-sim-ng
   *
   ...
   */
  class AquaSimDataHashTableS
  {
  public:
    std::map<int *, int *> m_htable;
    // Tcl_HashTable htable;
    AquaSimDataHashTableS();
    ~AquaSimDataHashTableS();
