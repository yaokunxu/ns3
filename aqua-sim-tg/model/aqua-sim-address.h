...
public:
  ...
  static Address IntConvertTo(uint16_t addr);
  ...
  static AquaSimAddress IpToAuqaAddress (Ipv4Address& ipAddr);
  static Ipv4Address AuqaAddressToIp (AquaSimAddress& aquaAddr);
