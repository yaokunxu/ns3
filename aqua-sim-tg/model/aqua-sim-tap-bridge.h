/*
 * aqua-sim-tap-bridge.h
 *
 *  Created on: Feb 25, 2020
 *      Author: anna
 */

#ifndef AQUA_SIM_TAP_BRIDGE_H_
#define AQUA_SIM_TAP_BRIDGE_H_
...
extern Ptr<Node> sink_node;
	 ...
	 */
	 class AquaSimTapBridgeFdReader : public FdReader
	 {
	 private:
	 ...
	 * itself, though.
	 */
	class AquaSimTapBridge:public NetDevice
	{
	public:
		/**
		 * add by zy,aqul-sim node
		 */
		 //NodeContainer aqul-node;
	  ...
	  */
		...
		//  void setNodeZy(Ptr<Node> node_zy_);
		 ...
		 */
		void SetMode(AquaSimTapBridge::Mode mode);
		 ...
		 */
		AquaSimTapBridge::Mode  GetMode(void);
	...
	private:
		 ...
		 */
		Ptr<AquaSimTapBridgeFdReader> m_fdReader;
