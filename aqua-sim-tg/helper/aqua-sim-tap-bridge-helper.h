...
#ifndef AQUA_SIM_TAP_BRIDGE_HELPER_H
#define AQUA_SIM_TAP_BRIDGE_HELPER_H
...
namespace ns3 {
	...
	public:
		 ...
		 * the created bridges,
		 */
		AquaSimTapBridgeHelper(Ipv4Address gateway);
...
#endif /* AQUA_SIM_TAP_BRIDGE_HELPER_H */
